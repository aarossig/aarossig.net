...
MARKDOWN = src/about.md \
		...
		src/retro_computing_windows_9x.md \
		src/ryobi_index.md \
...
IMG = src/res/about/aarossig_google_2014.jpg \
		...
		src/res/projects/retro/retro_computer_desk_photo.jpg \
    src/res/projects/retro/windows_95_dma_fix.png \
